...
class Toolkit:
    ...
    # Methods in Edges
    def edges(self, vertices: list, is_directed=False):
    ...
    # Methods in Matrices
    def adjacnecy_matrix(self, edges: list, vertices: list, is_directed: bool):
        return self.matrices.adjacnecy_matrix(edges, vertices, is_directed)
